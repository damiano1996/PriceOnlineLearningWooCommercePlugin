...
function add_all_products_from_settings()
{
    if (isset($_POST['add_all_products'])) {
        echo "<div>Number of new connected products: <b>" . add_update_and_save_all_products_to_pol() . "</b>.<br>";
    }
}
...
function pol_options_page_html()
{
    ...
    <div class="wrap">
        ...
        <div>
            ...
            If you click on the button below, products that are not present in your POL account will be inserted using
