...
class GeneralSettingsPage
{
    ...
    public function pol_options_page()
    {
        ...
        add_menu_page('Price Online Learning', 'POL', 'manage_options', 'pol-menu', array($this, 'pol_options_page_html'));
        add_submenu_page('pol-menu', 'Price Online Learning', 'General Settings', 'manage_options', 'pol-menu');
